...
const Dashboard = () => {
  ...
  return (
    ...
    <div className="dashboard-container">
      ...
      (
            <div className="d-flex div-shadow dashboard-banner">
          <div className="d-flex dashboard-banner-text">
            <h5>Dashboard</h5>
          ...
          <div className="d-flex flex-column countdown-container h-100">
      ...
      :
      (
            <div className="d-flex w-100 mb-4 div-shadow dashboard-banner">
            ...
            if(key.length > 0){
              ...
              switch (key[0]) {
                ...
                case "notebook":
                  ...
                  return <div key={content._id} className=" div-shadow dashboard-feature-container">
                    <Editor content={content.notebook} toolbarTheme="snow" onDashboard={true} />
                  </div>
                case "category":
